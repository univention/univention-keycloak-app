...
public class ApiClient {
    ...
    private String basePath = "https://ucs501.jtorres.org/univention/udm";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://ucs501.jtorres.org/univention/udm",
      "No description provided",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "http://ucs501.jtorres.org/univention/udm",
      "No description provided",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://10.200.92.100/univention/udm",
      "No description provided",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "http://10.200.92.100/univention/udm",
      "No description provided",
      new HashMap<String, ServerVariable>()
    )
  ));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://ucs501.jtorres.org/univention/udm
